...
set tags^=./.git/tags;/ " Look for tags in .git directories
...
" Persistent undo (NOTE: ~/.vim/undo must be created manually)
set undofile
...
" Don't center line vertically when inserting a matching delimiter
